...
import { transformAttribute, IGNORED_NODE, serializeNodeWithId, NodeType } from '../../node_modules/rrweb-snapshot/es/rrweb-snapshot.js';
...
var MutationBuffer = (function () {
    function MutationBuffer() {
        ...
        this.emit = function () {
            ...
            var pushAdd = function (n) {
                if (!n.parentNode || !_this.doc.contains(n)) {
                    return;
                }
                ...
                var sn = serializeNodeWithId(n, {
                    ...
                    onSerialize: function (currentN) {
                        if (currentN.__sn.type === NodeType.Element &&
    ...
    MutationBuffer.prototype.init = function (cb, blockClass, blockSelector, inlineStylesheet, maskInputOptions, recordCanvas, slimDOMOptions, doc, iframeManager) {

...
var mutationBuffers = [];
function initMutationObserver(cb, doc, blockClass, blockSelector, inlineStylesheet, maskInputOptions, recordCanvas, slimDOMOptions, iframeManager) {
    var _a, _b, _c;
    var mutationBuffer = new MutationBuffer();
    mutationBuffers.push(mutationBuffer);
    mutationBuffer.init(cb, blockClass, blockSelector, inlineStylesheet, maskInputOptions, recordCanvas, slimDOMOptions, doc, iframeManager);
...
function initMoveObserver(cb, sampling, doc) {
...
function initMouseInteractionObserver(cb, doc, blockClass, sampling) {
...
function initInputObserver(cb, doc, blockClass, ignoreClass, maskInputOptions, maskInputFn, sampling) {
        ...
        if (window) {
            ...
            window.onerror = function () {
                ...
                if (originalOnError_1) {
                    originalOnError_1.apply(_this, args);
                }
                var stack = [];
...
function initObservers(o, hooks) {
    ...
    mergeHooks(o, hooks);
    var mutationObserver = initMutationObserver(o.mutationCb, o.doc, o.blockClass, o.blockSelector, o.inlineStylesheet, o.maskInputOptions, o.recordCanvas, o.slimDOMOptions, o.iframeManager);
    var mousemoveHandler = initMoveObserver(o.mousemoveCb, o.sampling, o.doc);
    var mouseInteractionHandler = initMouseInteractionObserver(o.mouseInteractionCb, o.doc, o.blockClass, o.sampling);
    var scrollHandler = initScrollObserver(o.scrollCb, o.doc, o.blockClass, o.sampling);
    var viewportResizeHandler = initViewportResizeObserver(o.viewportResizeCb);
    var inputHandler = initInputObserver(o.inputCb, o.doc, o.blockClass, o.ignoreClass, o.maskInputOptions, o.maskInputFn, o.sampling);
...
export { INPUT_TAGS, initObservers, mutationBuffers };
